...
describe('User Entity', () => {
  describe('constructor', () => {
    ...
    it('should throw error for invalid email', () => {
      ...
      expect(() => new User(userData)).toThrow('El email es obligatorio y debe ser válido');
    });
    ...
    it('should throw error for email exceeding 255 characters', () => {
      ...
      expect(() => new User(userData)).toThrow('El email no puede exceder 255 caracteres');
    });
    ...
    it('should throw error for empty password', () => {
      ...
      expect(() => new User(userData)).toThrow('La contraseña debe tener al menos 6 caracteres');
    });
    ...
    it('should throw error for password exceeding 255 characters', () => {
      ...
      expect(() => new User(userData)).toThrow('La contraseña no puede exceder 255 caracteres');
    });
    ...
    it('should throw error for empty name', () => {
      ...
      expect(() => new User(userData)).toThrow('El nombre debe tener al menos 2 caracteres');
    });
    ...
    it('should throw error for name exceeding 255 characters', () => {
      ...
      expect(() => new User(userData)).toThrow('El nombre no puede exceder 255 caracteres');
    });
  ...
  describe('validateRole', () => {
    ...
    it('should reject case-sensitive invalid roles', () => {
      const invalidRoles = ['admin', 'user', 'viewer', 'Admin', 'User', 'Viewer'];
  ...
  describe('User methods', () => {
    ...
    describe('changePassword', () => {
      ...
      it('should throw error for invalid password', () => {
        ...
        expect(() => user.changePassword('123')).toThrow('La contraseña debe tener al menos 6 caracteres');
      ...
      it('should throw error for empty password', () => {
        ...
        expect(() => user.changePassword('')).toThrow('La contraseña debe tener al menos 6 caracteres');
      ...
      it('should throw error for null password', () => {
        ...
        expect(() => user.changePassword(null as any)).toThrow('La contraseña debe tener al menos 6 caracteres');
        expect(user.password).toBe(originalPassword);
      });
      ...
      it('should throw error for password exceeding 255 characters', () => {
        ...
        expect(() => user.changePassword(longPassword)).toThrow('La contraseña no puede exceder 255 caracteres');
        expect(user.password).toBe(originalPassword);
      });
    ...
    describe('changeRole', () => {
      ...
      it('should throw error for invalid role', () => {
        ...
        expect(() => user.changeRole('INVALID' as UserRole)).toThrow('Rol de usuario inválido');
      ...
      it('should throw error for null role', () => {
        ...
        expect(() => user.changeRole(null as any)).toThrow('Rol de usuario inválido');
        expect(user.role).toBe(originalRole);
      });
      ...
      it('should throw error for undefined role', () => {
        ...
        expect(() => user.changeRole(undefined as any)).toThrow('Rol de usuario inválido');
        expect(user.role).toBe(originalRole);
      });
    ...
    describe('updateName', () => {
      ...
      it('should throw error for invalid name', () => {
        ...
        expect(() => user.updateName('A')).toThrow('El nombre debe tener al menos 2 caracteres');
      ...
      it('should throw error for empty name', () => {
        ...
        expect(() => user.updateName('')).toThrow('El nombre debe tener al menos 2 caracteres');
        expect(user.name).toBe(originalName);
      });
      ...
      it('should throw error for null name', () => {
        ...
        expect(() => user.updateName(null as any)).toThrow('El nombre debe tener al menos 2 caracteres');
        expect(user.name).toBe(originalName);
      });
      ...
      it('should throw error for name exceeding 255 characters', () => {
        ...
        expect(() => user.updateName(longName)).toThrow('El nombre no puede exceder 255 caracteres');
        expect(user.name).toBe(originalName);
      });
