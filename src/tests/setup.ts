...
process.env.JWT_REFRESH_SECRET_KEY = process.env.JWT_REFRESH_SECRET_KEY || generateHexKey(32);
process.env.ENCRYPTION_SECRET_KEY = process.env.ENCRYPTION_SECRET_KEY || generateHexKey(32);
