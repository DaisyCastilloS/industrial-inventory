 ...
 */
export type InventoryStatsResponseDTO = z.infer<typeof InventoryStatsResponseSchema>;
 ...
 * @throws {Error} Si los datos son inválidos
 */
export function validateProductFullResponse(data: unknown): ProductFullResponseDTO {
 ...
 * @throws {Error} Si los datos son inválidos
 */
export function validateProductListResponse(data: unknown): ProductListResponseDTO {
 ...
 * @throws {Error} Si los datos son inválidos
 */
export function validateInventoryStatsResponse(data: unknown): InventoryStatsResponseDTO {
